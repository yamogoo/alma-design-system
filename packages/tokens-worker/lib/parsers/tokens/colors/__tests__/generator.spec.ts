...
import { generateDerivativeColors, generateColorsFromFile } from '../generator.ts';
...
describe('colors generator modules', () => {
  ...
  describe('generateDerivativeColors', () => {
  ...
  describe('generateColorsFromFile', () => {
    ...
    it('throws for non-json sources', () => {
      ...
      fs.writeFileSync(source, `palette
  primary: #fff`);
